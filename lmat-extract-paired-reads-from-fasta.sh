...
python $scripts/extract-paired-reads-from-fasta.py $lmat/$file.$file.micro-id.fasta $fastq/$file.non-rRNA.deconseq_clean.r1.fastq $fastq/$file.non-rRNA.deconseq_clean.r2.fastq $lmat/$file.micro.r1.fastq $lmat/$file.micro.r2.fastq
